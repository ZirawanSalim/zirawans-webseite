      ...
      <div className="max-w-4xl mx-auto text-center px-4">
        ...
        <div className="flex justify-center gap-6 mb-6">
          <a
            ...
            aria-label="GitHub-Profil von Zirawan Salim (oeffnet in neuem Tab)"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label="LinkedIn-Profil von Zirawan Salim (oeffnet in neuem Tab)"
            className="hover:text-gray-300 transition"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Behance Case Study UI/UX (oeffnet in neuem Tab)"
            className="hover:text-gray-300 transition"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
